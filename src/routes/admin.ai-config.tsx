                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    onClick={() => {
                      ...
                      speak("Bonjour ! Ceci est un test de la voix de studio ElevenLabs.", "fr-FR", 0.85, "female", form.selectedElevenLabsFemaleVoice, "elevenlabs", { elevenLabsApiKey: cleanKey });
                    }}
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <button
                      ...
                      onClick={() => {
                        const cleanKey = form.elevenLabsApiKey?.includes("...") ? undefined : form.elevenLabsApiKey;
                        speak("Bonjour ! Je suis Coach Léo, ravi de travailler avec vous.", "fr-FR", 0.85, "male", form.selectedElevenLabsMaleVoice, "elevenlabs", { elevenLabsApiKey: cleanKey });
                      }}
