      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className={`p-6 rounded-2xl border ${card} space-y-4`}>
          ...
          <p className={`text-xs ${txtSec}`}>
            Audio files generated by Kokoro-82M, ElevenLabs, or OpenAI are cached in MongoDB (`TTSCache`) for instant (< 50ms) playback for future students. Use <strong>Clear Audio Cache</strong> if you want to wipe cached audio and re-generate fresh audio using a newly selected engine.
          </p>
