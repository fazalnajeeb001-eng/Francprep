              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() => {
                      speak("Bonjour ! Ceci est un test de la voix de studio ElevenLabs.", "fr-FR", 0.85, "female", form.selectedElevenLabsFemaleVoice, "elevenlabs", { elevenLabsApiKey: form.elevenLabsApiKey });
                    }}
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        speak("Bonjour ! Je suis Coach Léo, ravi de travailler avec vous.", "fr-FR", 0.85, "male", form.selectedElevenLabsMaleVoice, "elevenlabs", { elevenLabsApiKey: form.elevenLabsApiKey });
                      }}
