        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} className={`p-6 rounded-2xl border ${card} space-y-4`}>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-3 border-t border-gray-200 dark:border-white/10 space-y-4">
              ...
              {form.activeTTSProvider === "elevenlabs" && (
                <div className="p-3.5 rounded-xl border border-pink-500/30 bg-pink-500/10 space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        type="button"
                        onClick={() => toggleAudio("Bonjour ! Ceci est un test de la voix de studio ElevenLabs.", "fr-FR", 0.85, "female", form.selectedElevenLabsFemaleVoice, "elevenlabs")}
              ...
              {form.activeTTSProvider === "huggingface" && (
                <div className="p-3.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 space-y-3 text-xs">
                  <div className="flex items-center justify-between">
