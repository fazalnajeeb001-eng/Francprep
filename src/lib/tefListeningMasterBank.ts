/**
 * 🇨🇦 Official TEF Canada Authentic Listening Master Bank (Paper 1)
 * Strictly calibrated according to CCI Paris Île-de-France (Le français des affaires)
 * 40 Authentic Items across 7 Typological Groups:
 *   - Groupe 1 (Q1-Q4): Conversations avec dessins (A1-A2)
...
import type { TefListeningItem } from "./tefExamSchema";

export const TEF_PAPER_1_LISTENING_ITEMS: TefListeningItem[] = [
  // ─── GROUPE 1 : CONVERSATIONS AVEC DESSINS (Q1 - Q4) ───
  {
    id: "tef-p1-co-q01",
    paperNumber: 1,
    questionNumber: 1,
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Voix d'annonce de gare"],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Hôtesse d'accueil magasin"],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Agent d'escale aéroportuaire"],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Coordinateur périscolaire"],
  ...
  // ─── GROUPE 3 : MICRO-TROTTOIRS (Q13 - Q18) ───
  // Thématique : L'interdiction des voitures individuelles dans les centres-villes
  {
    id: "tef-p1-co-q13",
    paperNumber: 1,
    questionNumber: 13,
  ...
  // ─── GROUPE 4 : ÉMISSIONS DE RADIO & INFORMATIONS (Q19 - Q28) ───
  {
    id: "tef-p1-co-q19",
    paperNumber: 1,
    questionNumber: 19,
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Journaliste scientifique"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Chroniqueuse économique"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Chroniqueur scientifique"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Chroniqueuse transports"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Chroniqueur tendances"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Journaliste numérique"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Météorologue spécialiste climat"],
  ...
  },
  {
    ...
    answerTimeSeconds: 20,
    speakerCount: 1,
    speakers: ["Chroniqueuse éducation"],
  ...
  // ─── GROUPE 5 : GRANDS ENTRETIENS & DÉBATS LONGS (Q29 - Q34) ───
  // Thématique : L'organisation du temps de travail et la semaine de quatre jours
  // Audio Document unique en 2 parties avec questions progressives
  {
    id: "tef-p1-co-q29",
    paperNumber: 1,
    questionNumber: 29,
    ...
    speakerCount: 2,
    speakers: ["Journaliste (Animateur)", "Dr. Maxime Vasseur (Sociologue du travail)"],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Haut fonctionnaire diplomate"],
