...
export const TEF_PAPER_1_LISTENING_GUIDANCE: Record<string, TefListeningGuidance> = {
  ...
  "tef-p1-co-q35": {
    id: "tef-p1-co-q35",
    trapAlert: "⚠️ Piège B2 Reportage : Ne confondez pas l'origine historique du réemploi (brocantes et caritatif) avec son statut contemporain (rouage économique adopté par la grande distribution).",
    trapAlertEn: "⚠️ B2 Report Trap: Do not confuse the historic roots of second-hand goods (flea markets/charity) with its contemporary stature (mainstream retail adoption).",
    audioCoach: "🎯 Stratégie TEF : Repérez l'opposition temporelle : 'Longtemps cantonnée aux brocantes (...) s'impose aujourd'hui comme un rouage économique à part entière'.",
    audioCoachEn: "🎯 TEF Strategy: Catch the chronological transition: 'Long confined to flea markets (...) establishing itself today as a full-fledged financial driver'.",
    detailedExplanation: "🎯 Réponse exacte : Sa transformation en secteur économique majeur adopté par la grande distribution.\n\n• Justification textuelle :\n« la filière de la seconde main s'impose aujourd'hui comme un rouage économique à part entière (...) incitant les géants de la distribution à ouvrir leurs propres rayons de réemploi. ».\n\n• Analyse des distracteurs :\n- Déclin progressif : Contredit formellement (6 ménages sur 10 le privilégient).\n- Limitation aux caritatifs : C'était son état antérieur (« longtemps cantonnée »).\n- Interdiction légale : Aucune entrave juridique citée.",
    detailedExplanationEn: "🎯 Correct Answer: Its transformation into a major economic sector embraced by mainstream retail.\n\n• Textual Evidence:\n'the second-hand economy is establishing itself as a full-fledged financial driver (...) prompting retail powerhouses to launch their own in-house reconditioned aisles.'\n\n• Distractor Breakdown:\n- Gradual decline: Directly contradicted (6 in 10 households favor it).\n- Limited to charities: That was its former state ('long confined').\n- Legal ban: No legal hindrance is mentioned."
  },
  "tef-p1-co-q36": {
    id: "tef-p1-co-q36",
    trapAlert: "⚠️ Piège B2 Chronique : Ne vous focalisez pas sur un seul élément : la question interroge sur le DOUBLE bénéfice (environnemental ET logistique local).",
    trapAlertEn: "⚠️ B2 Chronicle Trap: Do not focus on a single aspect: the item targets the DUAL advantage (environmental AND local municipal supply).",
    audioCoach: "🎯 Stratégie TEF : Identifiez le connecteur binaire 'non seulement (...) mais elles approvisionnent directement'.",
    audioCoachEn: "🎯 TEF Strategy: Identify the dual-marker connector: 'not only (...) but directly supply'.",
    detailedExplanation: "🎯 Réponse exacte : La préservation écologique des eaux et l'approvisionnement direct des cantines locales.\n\n• Justification textuelle :\n« ces fermes périurbaines parviennent non seulement à préserver les nappes phréatiques, mais elles approvisionnent directement les cantines scolaires des communes avoisinantes en circuits ultra-courts. ».\n\n• Analyse des distracteurs :\n- Exportations à l'étranger : Il s'agit expressément de « circuits ultra-courts » locaux.\n- Suppression des terres : Les terres sont au contraire valorisées en agroécologie.\n- Financement par les élèves : Hors sujet total.",
    detailedExplanationEn: "🎯 Correct Answer: Ecological water table protection and direct supply to local cafeterias.\n\n• Textual Evidence:\n'these peri-urban farms not only safeguard groundwater tables, but directly supply neighboring municipal school cafeterias through hyper-localized distribution loops.'\n\n• Distractor Breakdown:\n- Overseas exports: It explicitly concerns hyper-local short distribution loops.\n- Eliminating farmland: Farmland is actually revitalized through agroecology.\n- Student funding: Completely off-topic."
  },
  "tef-p1-co-q37": {
    id: "tef-p1-co-q37",
    trapAlert: "⚠️ Piège C1 Débat : La médiatrice ne critique pas la technologie en soi, mais l'absence de guichets physiques d'assistance créant une exclusion civique.",
    trapAlertEn: "⚠️ C1 Debate Trap: The ombudsman does not attack technology per se, but the elimination of in-person desks creating civic exclusion.",
    audioCoach: "🎯 Stratégie TEF : Isolez la condition de risque : 'Sans accompagnement humain de proximité (...) risque de transformer un outil de modernisation en un facteur d'exclusion'.",
    audioCoachEn: "🎯 TEF Strategy: Isolate the conditional risk statement: 'Without localized face-to-face assistance (...) risk converting modernization into exclusion'.",
    detailedExplanation: "🎯 Réponse exacte : Le risque d'exclure les populations fragiles privées d'accompagnement physique.\n\n• Justification textuelle :\n« Sans accompagnement humain de proximité au sein de guichets physiques, l'obligation du tout-en-ligne risque de transformer un outil de modernisation en un facteur d'exclusion civique et de non-recours aux droits. ».\n\n• Analyse des distracteurs :\n- Impossibilité technique des serveurs : Aucun problème technique de stockage n'est soulevé.\n- Disparition des formulaires : Les démarches subsistent sous forme dématérialisée.\n- Retour obligatoire au manuscrit : L'oratrice prône un accompagnement humain, non une régression passéiste.",
    detailedExplanationEn: "🎯 Correct Answer: The hazard of disenfranchising vulnerable groups deprived of physical in-person guidance.\n\n• Textual Evidence:\n'Without localized face-to-face assistance at physical service counters, all-digital mandates risk converting a modernization instrument into an engine of civic disenfranchisement and unclaimed social benefits.'\n\n• Distractor Breakdown:\n- Server technical failure: No technical hardware flaw is mentioned.\n- Forms disappearing: Procedures exist in digital formats.\n- Mandatory return to handwriting: She calls for human assistance, not an archaic regression."
  },
  "tef-p1-co-q38": {
    id: "tef-p1-co-q38",
