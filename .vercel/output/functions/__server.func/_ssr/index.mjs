...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-JG78WQwN.mjs");
...
const manifest = {
  "ed9e0b62e19345253bb81dfb20bac27bb23001205689ad75c3f2879c99c299c4": {
    ...
    importer: () => import("./index-Cb6denMy.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BlbYgGpR.mjs").then((n) => n.router),
