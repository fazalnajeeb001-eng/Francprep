...
async function main() {
  ...
  const l1Sections = [
    ...
    },
    {
      ...
      body: '"Deux Rencontres" (Two Encounters)\n\nLe matin, au bureau :\nCamille : Bonjour, Madame Petit !\nMadame Petit : Bonjour ! Je suis Madame Petit.\nCamille : Je suis Camille. Enchantée !\n\nLe soir, dans la rue :\nHugo : Salut, Léa !\nLéa : Salut, Hugo ! Ça va ?\nHugo : Ça va, merci. Bonne nuit, à bientôt !\nLéa : À bientôt !\n\nComprehension Questions:\n1. What time of day does the first conversation happen?\n2. Which greeting does Camille use with Madame Petit?\n3. Why does Hugo use salut instead of bonjour?\n4. What does Léa say at the very end?\n\nAnswer Key:\n1. Morning (le matin).\n2. Bonjour.\n3. Because he knows Léa well and it\'s an informal situation.\n4. À bientôt !',
