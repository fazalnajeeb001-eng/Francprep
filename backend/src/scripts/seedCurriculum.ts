...
function mapExerciseType(type: string): 'multiple_choice' | 'fill_blank' | 'matching' | 'listening' | 'writing' {
  const map: Record<string, 'multiple_choice' | 'fill_blank' | 'matching' | 'listening' | 'writing'> = {
