...
const PROMPTS_TO_PREWARM = [
  ...
  // Paper 8
  { paper: 8, task: 1, gender: 'female', voiceId: 'fr-FR-DeniseNeural', text: "Bonjour ! Je suis Denise, votre examinatrice certifiée pour le TCF Canada. Pour cet entretien dirigé de deux minutes sans préparation, pouvez-vous vous présenter et me parler de votre expérience personnelle dans l'apprentissage du français ?" },
  { paper: 8, task: 2, gender: 'female', voiceId: 'fr-FR-DeniseNeural', text: "Bienvenue dans la deuxième tâche. Vos deux minutes de préparation sur le dépliant de la visite guidée du musée d'art moderne sont écoulées. Échangeons pendant trois minutes et demie. Je suis le guide du musée. Posez-moi toutes vos questions !" },
  ...
  // Paper 9
  { paper: 9, task: 1, gender: 'male', voiceId: 'fr-FR-HenriNeural', text: "Bonjour ! Je m'appelle Henri, votre examinateur certifié pour le TCF Canada. Pour la première tâche sans préparation de deux minutes, pouvez-vous vous présenter et me décrire un projet ou une réussite dont vous êtes particulièrement fier ?" },
  { paper: 9, task: 2, gender: 'male', voiceId: 'fr-FR-HenriNeural', text: "Bienvenue dans la deuxième tâche. Après vos deux minutes de préparation sur l'annonce du centre de location de matériel de camping, nous entamons trois minutes et demie d'interaction. Je suis le responsable du magasin, M. Henri. Je vous écoute !" },
  ...
  // Paper 10
  { paper: 10, task: 1, gender: 'female', voiceId: 'fr-FR-VivienneMultilingualNeural', text: "Bonjour ! Je suis Vivienne, votre examinatrice officielle pour le TCF Canada. Commençons par la première tâche sans préparation de deux minutes. Pouvez-vous vous présenter, me parler de votre profession et me décrire ce que vous aimez faire le week-end ?" },
  { paper: 10, task: 2, gender: 'female', voiceId: 'fr-FR-VivienneMultilingualNeural', text: "Nous abordons la deuxième tâche. Vos deux minutes de préparation sur le programme du festival de musique d'été sont terminées. Échangeons pendant trois minutes et demie. Je suis l'organisatrice du festival, Vivienne. Posez-moi vos questions !" },
