...
export const env = {
  ...
  jwtAccessSecret: process.env.JWT_ACCESS_SECRET || process.env.JWT_SECRET || process.env.JWT_PASSWORD || generateSecret(),
  jwtRefreshSecret: process.env.JWT_REFRESH_SECRET || process.env.JWT_SECRET || process.env.JWT_PASSWORD || generateSecret(),
