...
const items = [
  // ── SECTION A : IDENTIFICATION DE DESSINS (Q1 - Q4) ──
  {
    ...
    speakerCount: 2,
    speakers: ["Client", "Pharmacienne"],
    speakerPersonas: [
      { role: "Client", gender: "male", voiceId: "fr-FR-HenriNeural" },
      { role: "Pharmacienne", gender: "female", voiceId: "fr-CA-SylvieNeural" }
    ],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 2,
    speakers: ["Cliente", "Cordonnier"],
    speakerPersonas: [
      { role: "Cliente", gender: "female", voiceId: "fr-FR-DeniseNeural" },
      { role: "Cordonnier", gender: "male", voiceId: "fr-FR-AlainNeural" }
    ],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 2,
    speakers: ["Client", "Moniteur"],
    speakerPersonas: [
      { role: "Client", gender: "male", voiceId: "fr-CA-AntoineNeural" },
      { role: "Moniteur", gender: "female", voiceId: "fr-FR-DeniseNeural" }
    ],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 2,
    speakers: ["Usager", "Agente"],
    speakerPersonas: [
      { role: "Usager", gender: "female", voiceId: "fr-FR-DeniseNeural" },
  ...
  // ── SECTION B : MESSAGES COURTS & ANNONCES PUBLIQUES (Q5 - Q12) ──
  {
    id: "tef-p5-co-q05",
    paperNumber: 5,
    questionNumber: 5,
    ...
    speakerCount: 1,
    speakers: ["Répondeur"],
    speakerPersonas: [{ role: "Répondeur", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Secrétaire"],
    speakerPersonas: [{ role: "Secrétaire", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Agent aéroportuaire"],
    speakerPersonas: [{ role: "Agent aéroportuaire", gender: "female", voiceId: "fr-CA-SylvieNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Garagiste"],
    speakerPersonas: [{ role: "Garagiste", gender: "male", voiceId: "fr-FR-AlainNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Gestionnaire"],
    speakerPersonas: [{ role: "Gestionnaire", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Coordinatrice"],
    speakerPersonas: [{ role: "Coordinatrice", gender: "female", voiceId: "fr-CA-SylvieNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Annonceur réseau"],
    speakerPersonas: [{ role: "Annonceur réseau", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Voix officielle"],
    speakerPersonas: [{ role: "Voix officielle", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  // ── SECTION C : MICRO-TROTTOIR (Q13 - Q18) ──
  // Thématique : La semaine de 4 jours de travail en entreprise sans perte de salaire
  {
    id: "tef-p5-co-q13",
    paperNumber: 5,
    questionNumber: 13,
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Nathalie"],
    speakerPersonas: [{ role: "Nathalie", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Sébastien"],
    speakerPersonas: [{ role: "Sébastien", gender: "male", voiceId: "fr-CA-AntoineNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Malika"],
    speakerPersonas: [{ role: "Malika", gender: "female", voiceId: "fr-CA-SylvieNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["François"],
    speakerPersonas: [{ role: "François", gender: "male", voiceId: "fr-FR-AlainNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Amandine"],
    speakerPersonas: [{ role: "Amandine", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  // ── SECTION D : REPORTAGES D'ACTUALITÉ & CHRONIQUES (Q19 - Q28) ──
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Journaliste"],
    speakerPersonas: [{ role: "Journaliste", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Chroniqueuse"],
    speakerPersonas: [{ role: "Chroniqueuse", gender: "female", voiceId: "fr-CA-SylvieNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Chroniqueur"],
    speakerPersonas: [{ role: "Chroniqueur", gender: "male", voiceId: "fr-FR-AlainNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Journaliste"],
    speakerPersonas: [{ role: "Journaliste", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  },
  {
    ...
    speakerCount: 1,
    speakers: ["Chroniqueur"],
    speakerPersonas: [{ role: "Chroniqueur", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  // ── SECTION E : LE GRAND ENTRETIEN (Q29 - Q34) ──
  // Thématique : L'intelligence artificielle générative et l'avenir des professions intellectuelles
  // Invitée : Dre Hélène Vasseur, sociologue du travail et chercheuse en sciences cognitives
  {
    id: "tef-p5-co-q29",
    paperNumber: 5,
    questionNumber: 29,
    ...
    answerTimeSeconds: 15,
    speakerCount: 2,
    speakers: ["Journaliste", "Dre Vasseur"],
    speakerPersonas: [
      { role: "Journaliste", gender: "male", voiceId: "fr-FR-HenriNeural" },
      { role: "Dre Vasseur", gender: "female", voiceId: "fr-CA-SylvieNeural" }
    ],
  ...
  // ── SECTION F : ACTES DE PAROLE & INTENTIONS IMPLICITES (Q35 - Q40) ──
  {
    id: "tef-p5-co-q35",
    paperNumber: 5,
    questionNumber: 35,
    ...
    speakerCount: 1,
    speakers: ["Directeur"],
    speakerPersonas: [{ role: "Directeur", gender: "male", voiceId: "fr-FR-AlainNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Président de jury"],
    speakerPersonas: [{ role: "Président de jury", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Négociatrice"],
    speakerPersonas: [{ role: "Négociatrice", gender: "female", voiceId: "fr-CA-SylvieNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Conseiller d'opposition"],
    speakerPersonas: [{ role: "Conseiller d'opposition", gender: "male", voiceId: "fr-FR-HenriNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Directrice des ressources humaines"],
    speakerPersonas: [{ role: "Directrice des ressources humaines", gender: "female", voiceId: "fr-FR-DeniseNeural" }],
  ...
  },
  {
    ...
    answerTimeSeconds: 15,
    speakerCount: 1,
    speakers: ["Éditorialiste"],
    speakerPersonas: [{ role: "Éditorialiste", gender: "male", voiceId: "fr-FR-AlainNeural" }],
...
items.forEach(it => {
  keyCounts[it.correctIndex] = (keyCounts[it.correctIndex] || 0) + 1;
});
console.log("Paper 5 Master Items Key Counts:", keyCounts);

if (keyCounts[0] !== 10 || keyCounts[1] !== 10 || keyCounts[2] !== 10 || keyCounts[3] !== 10) {
  console.error("ERROR: Paper 5 keys not balanced!", keyCounts);
  process.exit(1);
}
...
const outputPath = path.join(__dirname, "../src/lib/tefListeningPaper5Master.ts");
fs.writeFileSync(outputPath, header + JSON.stringify(items, null, 2) + ";\n", "utf-8");
console.log(`Successfully generated Paper 5 Master Bank at: ${outputPath}`);
